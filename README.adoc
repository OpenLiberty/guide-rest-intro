...
:page-seo-description: A getting started tutorial and an example on how to create a RESTful Java microservice in Open Liberty using the Java API for RESTful Web Services (JAX-RS) and JSON Binding (JSON-B).

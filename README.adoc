...
the JVM's system properties. The REST service will respond to `GET` requests made to the URL `\http://localhost:9080/LibertyProject/System/properties`
...
http://localhost:9080/LibertyProject/System/properties[http://localhost:9080/LibertyProject/System/properties^] URL. Automated tests are a much better
...
You developed a REST service in Open Liberty by using JAX-RS, JSON-P.

...
file. Open the [hotspot=1-210 file=1]`pom.xml` file to see how the application information such as the [hotspot=23 file=1]`<app.name/>`, [hotspot=24 file=1]`<testServerHttpPort/>` and [hotspot=25 file=1]`<testServerHttpsPort/>` elements are provided in the file.

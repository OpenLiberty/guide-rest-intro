...
:page-seo-title: Building a simple RESTful Java microservice using restfulWS and JSON-B
:page-seo-description: A getting started tutorial with examples of how to create a RESTful Java microservice in Open Liberty using the Java API for RESTful Web Services (restfulWS) and JSON Binding (JSON-B).

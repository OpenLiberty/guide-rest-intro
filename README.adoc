...
SystemApplication.java,lines=3-9
...
PropertiesResource.java,lines=5-25
[source,java,linenums,role='code_column']
----
...
[source,java,indent=0,role="command"]
----
...
[source,xml,indent=0,role="command"]
----

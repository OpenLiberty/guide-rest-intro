...
The Open Liberty server was already started at the begginning of the guide and all the 
changes have been automatically picked up.

Check out the service you created at the
http://localhost:9080/LibertyProject/System/properties[^] URL. 

When you are done checking out the services, stop the Open Liberty server simply press `CTRL+C` 

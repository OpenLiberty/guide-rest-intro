...
After you are done checking out the application, stop the Open Liberty server simply press CTRL+C in the shell session.
...
in the shell session where you ran development mode.

...
----
Create the JAX-RS application class file.
`src/main/java/io/openliberty/guides/rest/SystemApplication.java`
----

The [hotspot=1-9]`SystemApplication` class extends the `Application` class, which in turn associates all JAX-RS
resource classes in the WAR file with this JAX-RS application, making them available under the common
path specified in the `SystemApplication` class. The [hotspot=6-7]`@ApplicationPath` annotation has a
...
----
Create the JAX-RS resource class file.

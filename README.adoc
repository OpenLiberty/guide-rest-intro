...
the Maven [hotspot file=1]`bootstrap.properties` file. This is specified in the [hotspot=httpEndpoint file=0]`<httpEndpoint/>` element. Variables use the syntax `${variableName}`.
...
The Open Liberty server was already started in developer mode at the beginning of the guide and all the 
